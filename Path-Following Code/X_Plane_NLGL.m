function [f] = X_Plane_NLGL(L_psi, L_th, k_psi, k_th, k_t)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% X-Plane simulation using the NLGL algorithm
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% MAIN LOOP %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    while counter <= iterations && error_flag == 1
        ...
        % NLGL Algorithm
        [roll_d, pitch_d, error] = NLGL(UAV_position, loiter_position, radius, yaw(counter), pitch(counter), L_psi, L_th, k_psi, k_th, k_t, UAV_speed(counter), dt);
