function [f] = X_Plane_Vector(chi_app, tau, gamma, rho, xi, epsilon, lambda, k_psi, k_th, k_t)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% X-Plane simulation using the Vector Field algorithm
%
% INPUT  - Vector Field parameters:
%               * chi_app
%               * tau
%               * gamma
%               * rho
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% MAIN LOOP %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    while counter <= iterations && error_flag == 1
        ...
        [roll_d, pitch_d, error] = Vector_Field(UAV_position, loiter_position, radius, yaw(counter), pitch(counter), chi_app, tau, gamma, rho, xi, epsilon, lambda, k_psi, k_th, k_t, UAV_speed(counter), dt);
        ...
        if counter == 1
            ...
            x(counter+1) = -result(1) - INICIAL_X;
